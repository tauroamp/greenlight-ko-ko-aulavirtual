...
DROP DATABASE kkgreenlight_production;
DROP DATABASE old_greenlight_production;
...
REVOKE ALL ON DATABASE greenlight_production FROM PUBLIC;
REVOKE ALL ON DATABASE greenlight_production FROM postgres;
GRANT ALL ON DATABASE greenlight_production TO postgres;
GRANT CONNECT,TEMPORARY ON DATABASE greenlight_production TO PUBLIC;
CREATE DATABASE kkgreenlight_production WITH TEMPLATE = template0 OWNER = postgres;
CREATE DATABASE old_greenlight_production WITH TEMPLATE = template0 OWNER = postgres;
...
--
-- Name: fk_rails_60126080bd; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fk_rails_9946f3f4cf; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fk_rails_e557734f55; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\connect kkgreenlight_production
...
COPY public.ar_internal_metadata (key, value, created_at, updated_at) FROM stdin;
environment	production	2020-05-29 00:26:35.747226	2020-05-29 00:26:35.747226
\.
...
\connect old_greenlight_production
